...
class ResponsibilityParser:
    ...
    def extract_responsibilities_from_json(self, json_dict, filename, title):
        ...
        for resp_section in resp_sections:
            ...
            file_responsibility_sections.extend([resp_line for responsibility_section in responsibility_section_list for resp_line in self.parse_responsibility_list(responsibility_section, filename, title)])
    ...
    def main(self, files_input_directory, excel_save_filepath=None):
        ...
        for parse_file in tqdm(parse_files):
            ...
            file_responsibility_sections = self.extract_responsibilities_from_json(json_dict, filename,title)
            if file_responsibility_sections:
