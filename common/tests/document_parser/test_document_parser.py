...
import pytest
import shutil
from devtools import REPO_PATH

ORIGINAL_TEST_FILES = dict(
    ocr_pdf_file=os.path.join(REPO_PATH,
                              "devtools/universal_test_harness/data/crawler_output/2021-01-01T110000/Title 1.pdf"),
    ocr_pdf_metadata_file=os.path.join(REPO_PATH,
                                       "devtools/universal_test_harness/data/crawler_output/2021-01-01T110000/Title 1.pdf.metadata"),
    non_ocr_pdf_file=os.path.join(REPO_PATH,
                                  "devtools/universal_test_harness/data/crawler_output/2021-01-01T110000/Title 2.pdf"),
    non_ocr_pdf_metadata_file=os.path.join(REPO_PATH,
                                           "devtools/universal_test_harness/data/crawler_output/2021-01-01T110000/Title 2.pdf.metadata")
)
