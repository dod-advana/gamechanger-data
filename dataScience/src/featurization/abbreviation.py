...
def expand_abbreviations(text, dic: t.Union[t.Dict[str, t.Any], str] = "dataScience/src/featurization/data/abbreviations.json"):
    """
...
def expand_abbreviations_no_context(text, dic: t.Union[t.Dict[str, t.Any], str] = "dataScience/src/featurization/data/abbcounts.json"):
    """
...
def find_abbreviations(text, dic: t.Union[t.Dict[str, t.Any], str] = "dataScience/src/featurization/data/abbreviations.json"):
    """
