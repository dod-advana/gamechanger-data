# from dataScience.src.search.ranking import matamo as mt
from dataScience.src.search.ranking import search_data as meta
from dataScience.src.search.ranking import rank
import datetime
import pandas as pd
...
Usage:
    example:
    python -m dataScience.src.search.ranking.generate_ft -c test/small_corpus/ -dd 80 --prod dataScience/src/search/ranking/generated_files/prod_test_data.csv
...
prod_data_file = "dataScience/src/search/ranking/generated_files/prod_test_data.csv"
...
def generate_ft_doc(corpus_dir: str, days: int = 80, prod_data: str = prod_data_file):
    ...
    out_dir = "dataScience/src/search/ranking/generated_files"
    r = rank.Rank()
    day_delta = 80
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "-p",
        dest="prod_data",
        default="dataScience/src/search/ranking/generated_files/prod_test_data.csv",
