...
source $REPO_DIR/dataScience/setup_env.sh $2
export PYTHONPATH=$PYTHONPATH:$REPO_DIR

# Main script to load/save current topic models from s3 and store them in dataScience/models/topic_models/models
...
# otherwise it'll say module dataScience not found)
#
#
