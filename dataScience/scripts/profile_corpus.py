...
#from dataScience.src.text_handling.process import preprocess, bert_tokenizer
...
## copied from dataScience.src.text_handling.process
...
if __name__ == "__main__":
    ...
    bert_vocab = "./dataScience/src/text_handling/assets/bert_vocab.txt"
    sources_path = "./dataScience/scripts/corpus_doctypes.csv"
    #save_dir = "./dataScience/scripts/stats_output/"
