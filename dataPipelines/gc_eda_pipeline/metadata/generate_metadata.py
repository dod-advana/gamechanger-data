...
def generate_metadata_data(data_conf_filter: dict, file: str, audit_rec: dict,
    ...
    is_supplementary_data_successful, is_supplementary_file_missing, metadata_type, is_pds_data, is_syn_data, is_fpds_data, md_data = metadata_extraction(file, data_conf_filter, db_pool, db_pool_pbis)
