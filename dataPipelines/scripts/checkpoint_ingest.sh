...
function checkpoint_ingest() {
    ...
    ( mkdir -p $HOST_REPO_DIR/gamechangerml/models/topic_models/models/ \
      && \ 
      aws s3 cp s3://advana-raw-zone/gamechanger/models/topic_model/v1/20210208.tar.gz - | tar -xzf - -C $HOST_REPO_DIR/gamechangerml/models/topic_models/models/
