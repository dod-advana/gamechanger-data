...
JOB_NAME="${JOB_NAME:-MANIFEST_INGEST}"
JOB_SCRIPT="${REPO_DIR}/paasJobs/jobs/manifest_csv.sh"
SEND_NOTIFICATIONS="${SEND_NOTIFICATIONS:-yes}"
UPLOAD_LOGS="${UPLOAD_LOGS:-yes}"
SLACK_HOOK_CHANNEL="${SLACK_HOOK_CHANNEL}"
SLACK_HOOK_URL="${SLACK_HOOK_URL}"
S3_BASE_LOG_PATH_URL="${S3_BASE_LOG_PATH_URL:-s3://advana-data-zone/bronze/gamechanger/data-pipelines/orchestration/logs/manifest-ingest}"
...
export INPUT_MANIFEST_FILENAME="${INPUT_MANIFEST_FILENAME:-manifest.csv}"
