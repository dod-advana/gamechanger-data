...
S3_BASE_LOG_PATH_URL="${S3_BASE_LOG_PATH_URL:-s3://advana-raw-zone/gamechanger/data-pipelines/orchestration/logs/core-s3-upload}"
...
export S3_RAW_INGEST_PREFIX="${S3_RAW_INGEST_PREFIX:-}"
