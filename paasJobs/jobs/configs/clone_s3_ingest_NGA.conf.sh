...
S3_BASE_LOG_PATH_URL="${S3_BASE_LOG_PATH_URL:-s3://advana-raw-zone/gamechanger/data-pipelines/orchestration/logs/NGA-s3-ingest}"
...
export CURRENT_SNAPSHOT_PREFIX="${CURRENT_SNAPSHOT_PREFIX:-gamechanger/projects/nga/}"
export BACKUP_SNAPSHOT_PREFIX="${BACKUP_SNAPSHOT_PREFIX:-gamechanger/projects/nga/backup/}"
export LOAD_ARCHIVE_BASE_PREFIX="${LOAD_ARCHIVE_BASE_PREFIX:-gamechanger/projects/nga/load-archive/}"
export DB_BACKUP_BASE_PREFIX="${DB_BACKUP_BASE_PREFIX:-gamechanger/projects/nga/backup/db/}"
