...
JOB_NAME="${JOB_NAME:-LOCAL_UPLOAD}"
JOB_SCRIPT="${REPO_DIR}/paasJobs/jobs/local_upload.sh"
SEND_NOTIFICATIONS="${SEND_NOTIFICATIONS:-yes}"
UPLOAD_LOGS="${UPLOAD_LOGS:-yes}"
SLACK_HOOK_CHANNEL="${SLACK_HOOK_CHANNEL}"
SLACK_HOOK_URL="${SLACK_HOOK_URL}"
S3_BASE_LOG_PATH_URL="${S3_BASE_LOG_PATH_URL:-s3://advana-data-zone/bronze/gamechanger/data-pipelines/orchestration/logs/core-local-upload}"
...
export LOCAL_RAW_INGEST_DIR="${LOCAL_RAW_INGEST_DIR:-}"
export LOCAL_PARSED_INGEST_DIR="${LOCAL_PARSED_INGEST_DIR:-}"
...
export MAX_S3_THREADS="${MAX_S3_THREADS:-50}"
...
export CRAWLER_OUTPUT_LOCATION="${CRAWLER_OUTPUT_LOCATION-raw_docs/crawler_output.json}"
